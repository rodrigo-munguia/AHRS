...
if w == 0,
 ...
 dw_dW = [ W(1)/(W(1)^2 + W(2)^2 + W(3)^2)^(1/2), W(2)/(W(1)^2 + W(2)^2 + W(3)^2)^(1/2), W(3)/(W(1)^2 + W(2)^2 + W(3)^2)^(1/2)]
       
dw_dw_u = [[ delta_t/2,         0,         0]
           [         0, delta_t/2,         0]
           [         0,         0, delta_t/2]];
       
dM_dw_ua =  dMc_dw*dw_dW*dw_dw_u;      
   
%dM_dw_u = [dM_dw_ua + dM_dw_ub];
% Falta desarrollar  dM_dw_ub
%dfq_dw_u = dfq_dM*dM_dw_u; 
